...
public class BTConnectActivity extends AppCompatActivity {
    ...
    private final String TAG = BTConnectActivity.class.getSimpleName();
    ...
    private Button mSquirrelDetectOnly;
...
//    private CheckBox mLED1;
    ...
    public BluetoothSocket socket2 = null;
...
//        mDetectionBtn = (Button) findViewById(R.id.detection);
        mSquirrelDetectOnly = (Button) findViewById(R.id.squirrel_detect);
...
//            });
            ...
            mSquirrelDetectOnly.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
...
//                }
//            });
//            mDetectionBtn.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    try {
//                        detection();
...
//        itemHolder.textAddress.setText(deviceInfoModel.getDeviceHardwareAddress());
        Intent squirrel_detection = new Intent(BTConnectActivity.this, MainActivity.class);
        squirrel_detection.putExtra("device", this.device);
        squirrel_detection.putExtra("email_address", email);
//        squirrel_detection.putExtra("socket", String.valueOf(this.socket2));
//        squirrel_detection.putExtra("socket", String.valueOf(this.mBTSocket));
//        mBTSocket.close();
//        mBTSocket = null;
//        mConnectedThread.cancel();
        startActivity(squirrel_detection);
//        finish();
    }
    ...
    @SuppressLint("MissingPermission")
    private void squirrelDetectOnly() {
        Intent squirrel_detection_only = new Intent(BTConnectActivity.this, MainActivity.class);
        squirrel_detection_only.putExtra("email_address", email);
        startActivity(squirrel_detection_only);
        finish();
    }
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent squirrel_detection = new Intent(BTConnectActivity.this, MainActivity.class);
            squirrel_detection.putExtra("device", device);
            squirrel_detection.putExtra("email_address", email);
            startActivity(squirrel_detection);
            finish();
